<?php
    ...
    if(isset($_REQUEST['submit'])){
        ...
        $sql = "INSERT INTO riders_log(username, password, contact, address) VALUES('$user', '$pass', '$contact', '$address')";
	...
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Rider Registration</h4>	
			</div>
            ...
            <!-- form -->
				<form  method="post">
					...
					<div class="form-group">
						...
						<a href="rider-log.php">Already have account?</a>
					</div>
				</form>
			</div>
		</div>
